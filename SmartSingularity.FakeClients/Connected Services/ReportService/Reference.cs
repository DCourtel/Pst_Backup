...
namespace SmartSingularity.FakeClients.ReportService {
    ...
    public interface IReportServer {
        ...
        void RegisterClient(SmartSingularity.FakeClients.ReportService.Client client);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReportServer/RegisterClient", ReplyAction="http://tempuri.org/IReportServer/RegisterClientResponse")]
        System.Threading.Tasks.Task RegisterClientAsync(SmartSingularity.FakeClients.ReportService.Client client);
        ...
        void RegisterPstFile(string clientId, SmartSingularity.FakeClients.ReportService.PstFile pstFile);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReportServer/RegisterPstFile", ReplyAction="http://tempuri.org/IReportServer/RegisterPstFileResponse")]
        System.Threading.Tasks.Task RegisterPstFileAsync(string clientId, SmartSingularity.FakeClients.ReportService.PstFile pstFile);
        ...
        void RegisterBackupResult(string clientId, SmartSingularity.FakeClients.ReportService.BackupSession backupSession);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReportServer/RegisterBackupResult", ReplyAction="http://tempuri.org/IReportServer/RegisterBackupResultResponse")]
        System.Threading.Tasks.Task RegisterBackupResultAsync(string clientId, SmartSingularity.FakeClients.ReportService.BackupSession backupSession);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IReportServerChannel : SmartSingularity.FakeClients.ReportService.IReportServer, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ReportServerClient : System.ServiceModel.ClientBase<SmartSingularity.FakeClients.ReportService.IReportServer>, SmartSingularity.FakeClients.ReportService.IReportServer {
        ...
        public void RegisterClient(SmartSingularity.FakeClients.ReportService.Client client) {
            base.Channel.RegisterClient(client);
        }
        
        public System.Threading.Tasks.Task RegisterClientAsync(SmartSingularity.FakeClients.ReportService.Client client) {
        ...
        public void RegisterBackupResult(string clientId, SmartSingularity.FakeClients.ReportService.BackupSession backupSession) {
            base.Channel.RegisterBackupResult(clientId, backupSession);
        }
        
        public System.Threading.Tasks.Task RegisterBackupResultAsync(string clientId, SmartSingularity.FakeClients.ReportService.BackupSession backupSession) {
